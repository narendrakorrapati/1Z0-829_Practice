...
public class SimpleFunctionTest {
	...
	public static void main(String[] args) {
		...
		ToIntFunction<Customer> customerAge = (customer) -> customer.getAge();
		int totalAge = 0;
		for(Customer customer : customers) {
			totalAge = totalAge + customerAge.applyAsInt(customer);
		}
		System.out.println("Average Age: " + totalAge/customers.size());
